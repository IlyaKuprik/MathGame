...
public class PlayActivity extends AppCompatActivity {
    ...
    public void finishLevel(){
        ...
        alert.show();
        if (ID != MainActivity.SIZE - 1) COMPLETED_LEVELS[ID + 1] = 1;
        else printOnScreen("Поздравляем!Вы прошли игру!");
        saveArray();
    }
    ...
    public int randForPlusAndMinus(){
        switch (DIFFICULT){
            case 0: return (int)(Math.random()*9 + 1); // 1..9
    ...
    public int randForMultiply(){
        switch (DIFFICULT){
            ...
            case 1: return (int)(Math.random()*8 + 3);
            case 2: return (int)(Math.random()*8 + 5);
            case 3: return (int)(Math.random()*8 + 7);
            case 4: return (int)(Math.random()*8 + 7);
            case 5: return (int)(Math.random()*8 + 9);
            case 6: return (int)(Math.random()*8 + 9);
            case 7: return (int)(Math.random()*8 + 15);
            case 8: return (int)(Math.random()*7 + 18);
            case 9: return (int)(Math.random()*7 + 20);
            default: return 1;
        }
    }
    ...
    public int randForProduction(){
        switch (DIFFICULT){
            ...
            case 4: return (int)(Math.random()*10 + 12);
            case 5: return (int)(Math.random()*10 + 15);
            case 6: return (int)(Math.random()*10 + 20);
            case 7: return (int)(Math.random()*10 + 25);
            case 8: return (int)(Math.random()*10 + 35);
            case 9: return (int)(Math.random()*10 + 40);
            default: return 1;
        }
    }
    ...
    public void initValues() {
        ...
        if (extras != null) {
            ...
            TIME_FOR_LEVEL = extras.getLong("timeForLevel");
        }
        else {
            ID = 0;
